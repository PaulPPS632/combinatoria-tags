...
// Función para dividir las combinaciones en bloques de 5
async function hacerRequestsEnParalelo(combinaciones) {
    const batchSize = 5;
    let contador = 1; // Inicia el contador de combinaciones
    ...
    for (let i = 0; i < combinaciones.length; i += batchSize) {
        ...
        console.log(`Lote de ${batch.length} combinaciones procesado`);
    }
}

hacerRequestsEnParalelo(combinaciones);
